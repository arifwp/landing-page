...
const AboutSection = () => {
  return (
    <CContainer>
      <section id="aboutSection" style={{ width: "100%" }}>
        <VStack
          bg={"black"}
          align={"stretch"}
          px={10}
              ...
              <HStack align={"stretch"} mt={10}>
                ...
                <VStack align={"stretch"}>
                  ...
                  <Text
                    ...
                    fontSize={{ base: "12px", md: "14px", lg: "14px" }}
                  >
                    Negara yang kau tetapkan, kampung yang kau tinggali, rumah
                    yang kau huni, adalah kesenian. Udara yang kau hirup, air
                    yang engkau berendam, api unggun kepunganmu untuk kehangatan
                    bergaul, adalah kesenian
                  </Text>
                </VStack>
              </HStack>
